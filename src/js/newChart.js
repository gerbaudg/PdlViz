...
for (var i = 0; i < 6; i++ ) {color += letters[Math.floor(Math.random() * 16)];}
	return color;}
function radarChart() {var jsonData = $.ajax({url: 'json/voiture.json',dataType: 'json',}).done(function (results) {var feature = "nb de porte";
		var dataset = [];
		var labels = [];
		var data = [];
		var dataS = [];
...
>>>>>>> branch 'aodren' of https://github.com/gerbaudg/PdlViz.git
